...
class Mixin_NetworkMonitorHandler:
    ...
    def _handle_update(self):
        ...
        self.set_published_msg(self.msg.copy())
...
class NetworkMonitorHandler_V2(Mixin_NetworkMonitorHandler, Base_WSMessageHandler_V2):
    pass


class NetworkMonitorHandler_No_Thread(Mixin_NetworkMonitorHandler, Base_WSMessageHandler_No_Thread):
    pass


class NetworkMonitorHandler(Base_WSMessageHandler):
    ...
    def handle(self, msg: Union[dict,list, None]):
        ...
        """
        self.msg = copy.deepcopy(msg)
        print(f"NetworkMonitorHandler : handle : {self.msg}")
        ...
        try: 
            ...
            if 'action' in msg:
                ...
                logger.info (f"NetworkMonitorHandler : handle : {type(self.datas)}")
                logger.info(f"NetworkMonitorHandler : handle : {self.datas}")
