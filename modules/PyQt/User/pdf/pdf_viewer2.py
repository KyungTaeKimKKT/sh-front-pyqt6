...
from PyQt6.QtWidgets import QVBoxLayout, QHBoxLayout, QSizePolicy, QApplication
        ...
        if a0.parent() == self:
            if a1.type() == QEvent.Type.MouseButtonPress:
                if a1.button() == Qt.ForwardButton:
                    ...
                    self.back()
            elif a1.type() == QEvent.Type.Wheel:
...
class WebPageWidget(QWidget):
    ...
    def initLayout(self):
        ...
        subwgt = QWidget()
        subwgt.setSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
