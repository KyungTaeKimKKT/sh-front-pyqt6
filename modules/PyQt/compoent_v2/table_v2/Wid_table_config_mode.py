...
class Wid_TableConfigMode( QWidget ):
    ...
    def init_ui(self):
        ...
        self.PB_Init = QPushButton("모든 사용자에게 전송")
        h_layout.addWidget(self.PB_Init)
        ...
        self.PB_Init.clicked.connect(self.on_WS_Trigger)
    ...
    def on_WS_Trigger(self):        
        try:
            ...
            table_url = INFO.get_API_URL ( app_info={'div': 'Config', 'name':'Table설정'})
            url = f"{table_url}/{action_url}/".replace('//', '/')
