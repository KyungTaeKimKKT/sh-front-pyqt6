...
class TableView_품질경영_CS이력조회(TableView_품질경영_CS관리):
    pass
    # set_row_span_list = [
    #     ('일자', [] ),
    # ]
...
class TableModel_품질경영_CS이력조회(TableModel_품질경영_CS관리):
    pass
...
class TableDelegate_품질경영_CS이력조회(TableDelegate_품질경영_CS관리):
    pass
...
class Wid_table_품질경영_CS이력조회( Wid_table_품질경영_CS관리 ):
