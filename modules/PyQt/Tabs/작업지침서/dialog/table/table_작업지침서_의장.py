...
class TableModel_작업지침서_의장(My_TableModel):
...
class TableView_작업지침서_의장(My_TableView):
...
class Delegate_작업지침서_의장(My_Table_Delegate):
	def __init__(self, parent, **kwargs):
		super().__init__(parent, **kwargs)
		self._items = {
...
class Wid_Table_for_작업지침서_의장(QWidget , Handle_Table_Menu):
	"""
	...
	def __init__(self, parent,  **kwargs ):
		super().__init__( parent, **kwargs )		
		self.tableView:  TableView_작업지침서_의장
		self.table_model : TableModel_작업지침서_의장
		self.delegate : Delegate_작업지침서_의장
