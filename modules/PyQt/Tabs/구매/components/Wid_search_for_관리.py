...
### ui import
from modules.PyQt.Tabs.디자인관리.ui.Ui_search_compenet_디자인관리 import Ui_Search
...
class Wid_Search_for(QWidget, Qwidget_Utils):
	...
	def _update_config(self, **kwargs):
		...
		if hasattr( self, '고객사list') :
			...
			self.ui.comboBox_Gogaek.setEnabled(True)
		if hasattr( self, '구분list'):
			self.ui.comboBox_Gubun.addItems ( ['All'] + self.구분list)
			self.ui.comboBox_Gubun.setEnabled(True)
