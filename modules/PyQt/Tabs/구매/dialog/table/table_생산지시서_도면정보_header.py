...
class TableModel_생산지시서_도면정보_Header(My_TableModel):
...
class TableView_생산지시서_도면정보_Header(My_TableView):
...
class Delegate_생산지시서_도면정보_Header(My_Table_Delegate):
	def __init__(self, parent, **kwargs):
		super().__init__(parent, **kwargs)
		self._items = {
...
class Wid_Table_for_생산지시서_도면정보_Header(QWidget , Handle_Table_Menu):
	"""
	...
	def __init__(self, parent,  **kwargs ):
		super().__init__( parent, **kwargs )		
		self.tableView:  TableView_생산지시서_도면정보_Header		
		self.table_model : TableModel_생산지시서_도면정보_Header		
		self.delegate : Delegate_생산지시서_도면정보_Header		
	...
	def UI(self):
		...
		# self.tableView = TableView_생산지시서_도면정보_Header(self)
