...
class TableModel_생산지시서_SPG(My_TableModel):
...
class TableView_생산지시서_SPG(My_TableView):
...
class Delegate_생산지시서_SPG(My_Table_Delegate):
	def __init__(self, parent, **kwargs):
		super().__init__(parent, **kwargs)
		self._items = {
...
class Wid_Table_for_생산지시서_SPG(QWidget , Handle_Table_Menu):
	"""
	...
	def __init__(self, parent,  **kwargs ):
		super().__init__( parent, **kwargs )		
		self.tableView:  TableView_생산지시서_SPG
		self.table_model : TableModel_생산지시서_SPG
		self.delegate : Delegate_생산지시서_SPG
