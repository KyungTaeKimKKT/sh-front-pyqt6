...
class TableModel_생산지시서_도면정보_Body(My_TableModel):
...
class TableView_생산지시서_도면정보_Body(My_TableView):
...
class Delegate_생산지시서_도면정보_Body(My_Table_Delegate):
	def __init__(self, parent, **kwargs):
		super().__init__(parent, **kwargs)
		self._items = {
...
class Wid_Table_for_생산지시서_도면정보_Body(QWidget , Handle_Table_Menu):
	"""
	...
	def __init__(self, parent,  **kwargs ):
		super().__init__( parent, **kwargs )		
		self.tableView:  TableView_생산지시서_도면정보_Body		
		self.table_model : TableModel_생산지시서_도면정보_Body		
		self.delegate : Delegate_생산지시서_도면정보_Body		
