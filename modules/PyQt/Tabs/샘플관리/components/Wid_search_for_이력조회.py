...
### ui import
from modules.PyQt.Tabs.샘플관리.ui.Ui_search_compenet_관리 import Ui_Search
...
class Wid_Search_for(QWidget, Qwidget_Utils):
	...
	def init_InputDict(self) ->None:
		self.inputDict = {
			...
			'법인명' : self.ui.comboBox_Bumin,
			'시작일' : self.ui.dateEdit_Sijak,
			'종료일' : self.ui.dateEdit_Jongro,
			'담당자' : self.ui.comboBox_Damdang,
	...
	def user_defined_ui_setting(self):
		self.ui.comboBox_pageSize.addItems( INFO.Combo_table_row_Items)
