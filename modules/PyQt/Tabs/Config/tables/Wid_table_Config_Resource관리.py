...
class TableView_Config_Resource관리(Base_Table_View):
    pass

class TableModel_Config_Resource관리(Base_Table_Model):
...
class TableDelegate_Config_Resource관리(Base_Delegate):
...
class Wid_table_Config_Resource관리( Wid_table_Base_V2  ):

    def setup_table(self):
        self.view = TableView_Config_Resource관리(self) 
        self.model = TableModel_Config_Resource관리(self.view)
        self.delegate = TableDelegate_Config_Resource관리(self.view)
