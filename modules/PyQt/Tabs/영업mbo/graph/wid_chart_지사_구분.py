...
from modules.PyQt.Tabs.영업mbo.graph.pie_chart_지사_구분 import PieChartWidget
from modules.PyQt.Tabs.영업mbo.graph.combo_chart_지사_구분 import ComboChartWidget
...
class Wid_Chart_지사_구분(QWidget, LazyParentAttrMixin_V2):
    ...
    def on_apply_api_datas(self, datas: list[dict]):
        self.datas = datas
        self.pie_chart.set_data(copy.deepcopy(datas))
