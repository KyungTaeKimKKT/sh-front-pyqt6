...
from modules.PyQt.Tabs.영업mbo.graph.wid_chart_지사_고객사 import Wid_Chart_지사_고객사 as Chart
...
class MainWidget(Base_MainWidget):	
	def update_mapping_name_to_widget(self):
		if self.lazy_config_mode:
			...
			self.mapping_name_to_widget['Table'] =  None #Wid_Table(self)
...
class 년간보고_지사_고객사__for_Tab(BaseTab_V2, YearSearchMixin):
