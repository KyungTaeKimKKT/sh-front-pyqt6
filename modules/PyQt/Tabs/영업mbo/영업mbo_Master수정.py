...
class Master수정__for_stacked_Table( Base_Stacked_Table ):
...
class Master수정__for_Tab( BaseTab):
	no_edit_columns_by_coding = ['id', '매출_month', '매출_year', '현장명',  '부서','check_admin', '금액', '금액', 'id_made','등록자','등록일',
									'등록_weekno', '설정_fk' ]
	custom_editor_info = {
	...
	def create_ui(self):
		...
		self.stacked_table = Master수정__for_stacked_Table(self)
