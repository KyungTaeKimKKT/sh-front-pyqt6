...
from modules.PyQt.Tabs.일일업무.calendar.calendar_휴일 import QCalendar_휴일
...
class MainWidget(Base_MainWidget):	
	def update_mapping_name_to_widget(self):
		if self.lazy_config_mode:
			...
			self.mapping_name_to_widget['Calendar'] = QCalendar_휴일(self)



class 휴일등록_관리___for_Tab( BaseTab_V2 ):
