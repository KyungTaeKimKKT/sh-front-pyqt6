...
from modules.PyQt.Tabs.일일업무.tables.Wid_table_일일업무_개인_전사 import Wid_table_일일업무_개인_전사 as Wid_Table
...
class 개인_전사__for_Tab( BaseTab_V2):
...
# class 개인_전사__for_stacked_Table( Base_Stacked_Table ):
# 	def create_active_table(self):
# 		return Wid_table(self)	

# class 개인_전사__for_Tab( BaseTab):
...
# 		self.stacked_table = 개인_전사__for_stacked_Table(self)
