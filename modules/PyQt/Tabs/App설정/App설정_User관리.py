...
from modules.PyQt.Tabs.App설정.tables.Wid_table_App설정_user관리 import Wid_table_App설정_User관리 as Wid_table
...
class User관리__for_Tab(BaseTab_V2):
	# no_edit_columns_by_coding = ["id","last_login", ]
