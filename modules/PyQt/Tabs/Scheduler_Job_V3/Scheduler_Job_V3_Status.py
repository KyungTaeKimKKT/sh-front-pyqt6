...
from modules.PyQt.Tabs.Scheduler_Job_V3.tables.wid_table_job_status import Wid_table_job_status
...
class MainWidget(Base_Stacked_Table):
	...
	def create_active_table(self):
		return Wid_table_job_status(self)

class Status__for_Tab(BaseTab_V2):
